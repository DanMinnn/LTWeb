    ...
    public class NhanVienController : Controller
    {
        ...
        public ActionResult ThemMoi(NhanVien model)
        {
            ...
            if (string.IsNullOrEmpty(model.MaNV) == true || string.IsNullOrEmpty(model.HoTen) == true ||
             string.IsNullOrEmpty(model.GioiTinh) == true || string.IsNullOrEmpty(model.SDT) == true || string.IsNullOrEmpty(model.Email) == true || string.IsNullOrEmpty(model.CCCD) == true)
            {
